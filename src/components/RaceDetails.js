    ...
    return (
      <div className="grid justify-center items-center align-middle">
        ...
        <div className=" bg-green-700 text-white rounded-2xl p-5">
          <h2 className=" text-xl font-semibold">NAME: {this.state.closestRace ? this.state.closestRace["raceName"] : "Loading..."} </h2>
          ...
          <h3 className=" text-sm font-semibold">TIME: {this.state.closestRace ? this.state.closestRace["time"] : "Loading..."} </h3>
          <h3 className=" text-sm font-semibold">SEASON {this.state.closestRace ? this.state.closestRace["season"] : "Loading..."} </h3>
        </div>
      </div>
