    ...
    <div className='grid'>
      ...
      <Router>
        <Routes>
          ...
          <Route exact path="/arabic" element={<F1Arabic name='Arabic' link= 'https://shls-live-event2-prod-dub.shahid.net/out/v1/0456ede1a39145d98b3d8c8062ddc998/index_7.m3u8'/>}/>
